...
func TestLeafNodeConnectionLimitsCluster(t *testing.T) {
	...
	port: -1
	operator = "./configs/nkeys/op.jwt"
    system_account = "a03d5f45ce2cd459d5e0a771ef492d15b5b47d076e961e6aab7a2b9f470dcf2fd2c99e7"
	resolver = MEMORY
	cluster {
		port: -1
		name: xyz
    ...
    resolver_preload = {
        a03d5f45ce2cd459d5e0a771ef492d15b5b47d076e961e6aab7a2b9f470dcf2fd2c99e7 : "eyJ0eXAiOiJqd3QiLCJhbGciOiJzZWNwMjU2azEifQ..EeuMgQzL4XvT46Ceus_BUEPJNRmIh5VDQkCqBFicvwcewvOtcW_5eN2dePO-1ZO4JuKNQfu9GFAqja5sT45BjQ"
    }
	`
	conf := createConfFile(t, []byte(content))
	defer removeFile(t, conf)
